...
from roop.utilities import conditional_download, configure_runtime_asset_env, get_model_path, get_models_directory_path, is_image, is_video
...
def get_face_swapper() -> Any:
    ...
    with THREAD_LOCK:
        if FACE_SWAPPER is None:
            ...
            model_path = get_model_path('inswapper_128.onnx')
